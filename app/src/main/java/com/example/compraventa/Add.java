...
public class Add extends AppCompatActivity implements View.OnClickListener {
    EditText titulo,precio,descrpcion;
    GridView gvGalery;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        descrpcion=findViewById(R.id.addDescription);
    ...
    private void enviar() {
        try {
            ...
            req.put("description",descrpcion.getText().toString());
            if(imageList.size()==0){
                Toast.makeText(Add.this, "debe de insertar una imagen", Toast.LENGTH_SHORT).show();
                return;
            }else {
        ...
        try {
            if(requestCode==CODE_GALERIA&&resultCode==RESULT_OK){
                ...
                if(data.getClipData()!=null){
                    ...
                    imageList.add(getRealPath(Add.this,imageUri));
                    ArrayList<Uri> uriArray=new ArrayList<>();
