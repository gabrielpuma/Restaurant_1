package com.example.compraventa.detalle;
    ...
    private void cargar() {
        ...
        client.get(ip+"/prod/detalle/"+id,null,new JsonHttpResponseHandler(){
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                //Toast.makeText(DetalleProducto.this, ""+ob, Toast.LENGTH_SHORT).show();
                try {
                    ...
                    for(int i=0;i<arr.length();i++){
                        ...
                        adp.add(new ItemImg(ob2.getString("url")));
                    }
                    Toast.makeText(DetalleProducto.this, ob.getString("message"), Toast.LENGTH_SHORT).show();
                }catch (JSONException e){
                    Toast.makeText(DetalleProducto.this, ""+e, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
